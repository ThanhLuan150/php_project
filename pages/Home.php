...
<body>
    ...
    <div class="container">
            ...
            <?php
            $conectsql = mysqli_connect("localhost", 'root', '', 'rent_clothers') or die("false");
            $sql = "select image, clothes.name, rent_prices  from clothes,categories where clothes.id_categories= 1 and categories.id_categories = 1";
            $show = mysqli_query($conectsql, $sql) or die("lỗi");
            ?>
        ...
        <div class="container">
            <p class="backgroundp1">Áo giao lĩnh</p>
            <?php
            $conectsql = mysqli_connect("localhost", 'root', '', 'admin') or die("false");
            $sql = "select image, id_clothes ,categories.name, clothes.name, rent_prices  from clothes,categories where clothes.id_categories= 1 and categories.id_categories = 1";
            $show = mysqli_query($conectsql, $sql) or die("lỗi");
            ?>
                <div class="list_schools">
                    <?php while ($row = mysqli_fetch_assoc($show)) { ?>
                        <div class="item">
                            ...
                            <br>
                            <div class="informationproduct">
                                <p class="informationproductp1"><?php echo $row["clothes.name"]; ?></p>
                                <p class="informationproductp2"><?php echo $row["rent_prices"]; ?></p>
                                <div class="button111">
        ...
        <div class="container">
            ...
            <?php
            $conectsql = mysqli_connect("localhost", 'root', '', 'admin') or die("false");
            $sql = "select image, categories.name, clothes.name, rent_prices  from clothes,categories where clothes.id_categories= 1 and categories.id_categories = 1";
            $show = mysqli_query($conectsql, $sql) or die("lỗi");
            ?>
                <div class="list_schools">
                    <?php while ($row = mysqli_fetch_assoc($show)) { ?>
